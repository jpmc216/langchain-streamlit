...
st.header("Build a LLM model using Langchain! 👋")
...
# os.environ['OPENAI_API_KEY'] = "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"
# df_csv = pd.read_csv("/Users/pjasthi/Downloads/sales.csv", sep="\t",)
